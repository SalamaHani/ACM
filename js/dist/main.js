...
//navbar
var nav = document.querySelector(".bour");
var navre = document.querySelector(".resbonsev");
var items = document.querySelectorAll(".bour .container .nav-item a");
var imgs = document.querySelectorAll(".navbar-brand .img");
window.onscroll = function () {
  if (window.scrollY >= 10) {
    nav.classList.add("bg-white");
    navre.classList.add("bg-white");
    imgs.forEach(function (im) {
      im.setAttribute("src", "/assets/images/BHHS-FoxRoach-Logo_1Line_Black-2.png");
    });
    ...
    imgs.forEach(function (im) {
      im.setAttribute("src", "/assets/images/BHHS-FoxRoach-Logo_1Line-White-2.png");
    });
    for (var _i = 0; _i < items.length - 1; _i++) {
      items[_i].classList.remove("text-black");
    }
  }
};
///Accertion
var item = document.querySelectorAll(".item");
var hed = document.querySelectorAll(".hed");
var box = document.querySelectorAll(".text-contact");
var open = document.querySelectorAll("#open");
var close = document.querySelectorAll("#close");
var contact = document.querySelector(".section-content");
var _loop = function _loop(i) {
  hed[i].addEventListener("click", function () {
    if (!box[i].getAttribute("class").includes("activ")) {
      for (var _i2 = 0; _i2 < hed.length; _i2++) {
        box[_i2].classList.remove("activ");
        open[_i2].classList.remove("act");
      }
    }
...
///Mang aleret
var Titems = document.querySelectorAll(".section-Managemnt-Team .contaer .sectipon-one .items");
var name = document.querySelectorAll(".items h3");
var descrttion = document.querySelectorAll(".items span");
var img = document.querySelectorAll(".items .img img");
// $(function(){
//     $.ajax({
//         url:'employees.json',
//         dataType:'json',
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkberkshire_hathawa"] = self["webpackChunkberkshire_hathawa"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./assets/js/main.js")))
